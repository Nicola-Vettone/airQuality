            ...
            <Col key={model.id} xs={12} sm={6} md={4}>
              <Link className="text-decoration-none" to={"/cube3D"}>
                <Card className="shadow-lg border-0 rounded-4 overflow-hidden">
                  <Card.Img
                    variant="top"
                    src="https://plus.unsplash.com/premium_photo-1671233269780-89a290d75b2a?q=80&w=1932&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                    className="card-img"
                  />
